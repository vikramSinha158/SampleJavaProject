...
public class ServiceAutomationRuleStepDef extends BasePage {
	...
	public void user_enters_rule_name_Patient_Type_Facility_Patient_Type_and_rule_Accuracy(String ruleName,
			String patientType, String facilityPatientType) {
	...
	public void user_enters_Facility_code_and() throws IOException {
		serviceAutomationRulePage.enterFacilityCode();
	}
