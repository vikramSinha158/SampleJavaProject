...
public class FCCStepDef {
	...
	public void user_should_be_able_to_view_the_labels_with_values(String type, String note)
	...
	@Then("^user fetch the \"([^\"]*)\" from Query FCC_392109_SQL1$")
	public void user_fetch_the_from_Query_FCC_392109_SQL1(String query)
			throws ClassNotFoundException, SQLException, IOException {
		fccPage.runQueryTranServer(query);
