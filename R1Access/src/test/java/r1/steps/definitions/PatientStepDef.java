...
public class PatientStepDef extends BasePage {
	...
	public void user_should_be_able_to_view_patient_details(String query)
			throws ClassNotFoundException, IOException, SQLException {
	...
	@When("^user runs the query \"([^\"]*)\" for patient deatils$")
	public void user_runs_the_query_for_patient_deatils(String query)
