...
public class PFAStepDef {
	...
	public void user_is_on_R_Access_home_page(int arg1) {
	...
	@Given("^user clicks on PFA Level (\\d+) Questions link\\.$")
	public void user_clicks_on_PFA_Level_Questions_link(int arg1) {
	...
	@When("^Input values in the \"([^\"]*)\" and \"([^\"]*)\" fields$")
	public void input_values_in_the_and_fields(String arg1, String arg2) {
	...
	@Then("^PFA Level(\\d+) question should be created with message \"([^\"]*)\"$")
	public void pfa_Level_question_should_be_created_with_message(int arg1, String arg2) {
	...
	@When("^user input values in the \"([^\"]*)\" and \"([^\"]*)\" fields$")
	public void user_input_values_in_the_and_fields(String arg1, String arg2) {
	...
	public void new_answer_should_be_added_in_the_answers_grid_with_message(String arg1) {
	...
	@Then("^message answer added for the question successfully appear$")
	public void message_answer_added_for_the_question_successfully_appear() {
	...
	public void message_answer_unlinked_successfully_appear_for_the_question_should_be_appear() {
