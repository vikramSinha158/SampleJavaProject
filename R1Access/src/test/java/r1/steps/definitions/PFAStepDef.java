...
public class PFAStepDef extends BasePage {
   ...
   @Given("^user clicks on Settings link$")
	...
	public void user_fetch_the_encounterid_from_Query_PFA_SQL10() throws ClassNotFoundException, IOException, SQLException {
		eId = pfaPage.getEncounterIdFor_PFA_419028_SQL10();
	}
	
	@When("^user fetch the encounterid from Query PFA_419029_SQL11$")
	public void user_fetch_the_encounterid_from_Query_PFA_SQL11() throws ClassNotFoundException, IOException, SQLException {
		eId = pfaPage.getEncounterIdFor_PFA_419029_SQL11();
	}
	
	@When("^user fetch the encounterid from Query PFA_419030_SQL12$")
	public void user_fetch_the_encounterid_from_Query_PFA_SQL12() throws ClassNotFoundException, IOException, SQLException {
	...
	/*@When("^user fill all the L1 Screening Questions$")
	public void user_fill_all_the_L_Screening_Questions(int arg1) {
	    pfaPage.verifyScreeningQuestionTab();
