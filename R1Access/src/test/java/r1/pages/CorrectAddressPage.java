...
public class CorrectAddressPage extends BasePage {
	...
	public void verifyPriorBalNotNull(String colName) {
		ArrayList<String> valList = R1AccessCommonMethodsRef.getTableColValue(ReturnedMailTableRow,
				ReturnedMailTableHeader, "colName");
		boolean flag = true;
	...
	public void verifyPatTabAsDefault() {
		Assert.assertTrue("Patient tab is not by set as by default",
				patTabVerifyMsg.getText().contains("Patient Visit and Address"));
	}
	...
	public void verifyAddedNotes(String text) {
		...
		Assert.assertTrue("Notes didn't got added",
				notelastLog.getText().toString().contains(formattedDate.toString()));
